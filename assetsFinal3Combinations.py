    ...
    # get VALUE
        ...
        for file2 in os.listdir(os.path.join("results_FINAL_equityBondsPartialCommodity2", "trades")):
            ...
            # get CONTRA
                ...
                for file3 in os.listdir(os.path.join("results_FINAL_equityBondsPartialCommodity2", "trades")):
                    if "value" in file3:
                        continue
                    ...
                    # get MOMENTUM
                        ...
                        ##################
                        file_trades_3 = os.path.join("results_FINAL_equityBondsPartialCommodity2", "trades", file3) # here I need the signal per day
                        ...
                        # SAVE
                        trades_df.to_csv(os.path.join("results_FINAL_equityBondsPartialCommodity2", "baseline3", file[33:-11] + "__" + file2[33:-11] + "__" + file3[33:-11] + ".csv"))
                        with open(os.path.join("results_FINAL_equityBondsPartialCommodity2", "baseline3", "summary.txt"), "a") as f:  # 'a' mode appends to the file without overwriting

    ...
    # get VALUE (vola)
        ...
        for file2 in os.listdir(os.path.join("results_FINAL_equityBondsPartialCommodity2", "trades")):
            ...
            # get CONTRA
                ...
                # SAVE
                trades_df.to_csv(os.path.join("results_FINAL_equityBondsPartialCommodity2", "adv_baseline2", file[33:] + "_____" + file2[33:]))
                with open(os.path.join("results_FINAL_equityBondsPartialCommodity2", "adv_baseline2", "summary.txt"), "a") as f:  # 'a' mode appends to the file without overwriting
